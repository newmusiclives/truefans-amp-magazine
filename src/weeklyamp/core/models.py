...
class EmailConfig(BaseModel):
    ...
    smtp_password: str = ""
    from_address: str = ""
    from_name: str = "TrueFans DISPATCH"
...
class PodcastConfig(BaseModel):
    enabled: bool = False
    intro_text: str = "Welcome to TrueFans DISPATCH, the podcast."
    outro_text: str = "Thanks for listening to TrueFans DISPATCH."
